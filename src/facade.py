...
class NetworkFacade():
    ...
    def train_step_d(self, train_image,noiseless_gt, coords):
        with tf.GradientTape() as tape:
            ...
            loss = compute_loss_decode(coords, logits, noiseless_gt, cs_out, train_image, mat)#todo, cs_out, noiseless_gt)
    ...
    def loop_d(self, dataset, save=True):
        ...
        for i,(train_image,noiseless_gt, coords,t, sigma) in enumerate(dataset):
            #train_image,noiseless_gt, coords,t, sigma = iterator.get_next()#todo: train all 3 at once
            if i%4 !=0:
