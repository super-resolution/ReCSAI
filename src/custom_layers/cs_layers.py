...
class CompressedSensingInception(tf.keras.layers.Layer):
    def __init__(self,*args, iterations, **kwargs ):
        ...
        self.convolution5x1_x = tf.keras.layers.Conv2D(16,(5,1),strides=(2,2), activation=None,padding="same",name="asdf1")#reduce dim by 2
        self.convolution1x5_x2 = tf.keras.layers.Conv2D(32,(1,5),strides=(2,2), activation=None,padding="same")#reduce dim by 2
        self.convolution5x5_x3 = tf.keras.layers.Conv2D(64,(5,5),strides=(2,2), activation=None,padding="same")#reduce dim by
